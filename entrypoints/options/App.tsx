...
import { ActionProviderStorage, BubbleOffsetStorage, GroupOrderStorage } from '@/utils/storage'
...
function App() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      // 加载气泡偏移设置
      const offsetData = await BubbleOffsetStorage.getValue()
      setBubbleOffset(offsetData)
    }
    fetchData()
  }, [])
